...
export const Navbar = () => {
  ...
  return (
    <nav className='fixed mx-auto border border-[#33353F] border-t-transparent border-r-transparent border-l-transparent top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100'>
